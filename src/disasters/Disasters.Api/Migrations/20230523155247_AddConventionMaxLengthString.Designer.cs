...
namespace Disasters.Api.Migrations
{
    ...
    [Migration("20230523155247_AddConventionMaxLengthString")]
    partial class AddConventionMaxLengthString
    {
            ...
            modelBuilder.Entity("Disasters.Api.Db.Disaster", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Occured = new DateTimeOffset(new DateTime(2023, 5, 23, 17, 52, 47, 380, DateTimeKind.Unspecified).AddTicks(8710), new TimeSpan(0, 2, 0, 0, 0)),
                            Summary = "Seed"
                        });
                });
